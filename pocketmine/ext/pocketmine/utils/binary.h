...
ZEND_BEGIN_ARG_INFO_EX(arginfo_pocketmine_utils_binary___s_not, 0, 0, 1)
	ZEND_ARG_INFO(0, s)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(pocketmine_utils_binary_method_entry) {
	...
	PHP_ME(PocketMine_Utils_Binary, readShort, arginfo_pocketmine_utils_binary_readshort, ZEND_ACC_PUBLIC)
	PHP_ME(PocketMine_Utils_Binary, writeShort, arginfo_pocketmine_utils_binary_writeshort, ZEND_ACC_PUBLIC)
	PHP_ME(PocketMine_Utils_Binary, readLShort, arginfo_pocketmine_utils_binary_readlshort, ZEND_ACC_PUBLIC)
	PHP_ME(PocketMine_Utils_Binary, writeLShort, arginfo_pocketmine_utils_binary_writelshort, ZEND_ACC_PUBLIC)
	PHP_ME(PocketMine_Utils_Binary, readInt, arginfo_pocketmine_utils_binary_readint, ZEND_ACC_PUBLIC)
	PHP_ME(PocketMine_Utils_Binary, writeInt, arginfo_pocketmine_utils_binary_writeint, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(PocketMine_Utils_Binary, readLInt, arginfo_pocketmine_utils_binary_readlint, ZEND_ACC_PUBLIC)
	...
	PHP_ME(PocketMine_Utils_Binary, __s_not, arginfo_pocketmine_utils_binary___s_not, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC)
